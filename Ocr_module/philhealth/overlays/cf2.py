"""Overlay field coordinate map - CF2 (612x936 pt).

Ported field-for-field from PClaimAssist/js/pdf/overlays/cf2.js
(window.PDF_OVERLAY_CF2). top/left/w are percent of the rendered page
(0-100); do not re-derive these by hand - they came from actual PDF
text/rect extraction against the real CF2.pdf template.
"""
